...
df_restriction = pd.read_csv('https://raw.githubusercontent.com/FabioPalliparambil98/covid-dataset/main/combined_restrictiontweets.csv')
df_vaccination = pd.read_csv('https://raw.githubusercontent.com/FabioPalliparambil98/covid-dataset/main/combined_vaccinationtweets.csv')
...
def hashtag(df_general,df_restriction,df_vaccination):
    ...
    hashtag_vaccination = pd.DataFrame({'Hashtag':list(vaccination_tag.keys()),'Count':list(vaccination_tag.values())})
